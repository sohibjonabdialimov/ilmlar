  ...
  return (
    ...
    >
      <div className="main-cart" style={{cursor: "pointer"}}>
        ...
        <img src={urlJoin(`${import.meta.env.VITE_API_KEY}`, `${deleteplatforma(props?.cart?.obloshka)}`)} alt="" />
        <div className="cart-desc_wrap">
          ...
          <div className="desc">
            {
              teacher.path?<img className="small_img" src={urlJoin(`${import.meta.env.VITE_API_KEY}`, `${deleteplatforma( teacher.path)}`)} alt="" />:<img src={defaultuser}></img>
            }
